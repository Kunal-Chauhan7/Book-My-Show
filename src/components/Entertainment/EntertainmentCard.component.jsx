...
const EntertainmentCardSlider = ()=>{
  const EntertainmentImage = [
    ...
    "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:l-text,ie-NCBFdmVudHM%3D,co-FFFFFF,ff-Roboto,fs-64,lx-48,ly-320,tg-b,pa-8_0_0_0,l-end:w-300/kids-zone-collection-202211140440.png",
    ...
    "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:l-text,ie-MTAgRXZlbnRz,co-FFFFFF,ff-Roboto,fs-64,lx-48,ly-320,tg-b,pa-8_0_0_0,l-end:w-300/music-shows-collection-202211140440.png",
  ...
  return <>
    <Slider {...settings}>
      {EntertainmentImage.map((image , index) => <EntertainmentCard src={image}
      key={index}
      />)}
    </Slider>
  </>
